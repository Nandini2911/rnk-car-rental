...
Whether you're renting for business or leisure, our well-maintained fleet and personalised support ensure that your journey is comfortable, convenient, and worry-free.`,
    imageTitle: "RNK Rent A Car premium vehicle fleet",
...
Indulge in smooth rides, elegant interiors, and top-tier features — because you deserve nothing less.`,
    imageTitle: "RNK Rent A Car luxury vehicle interior",
...
From business travel to family vacations, our customisable solutions ensure you get exactly what you need, with no compromise on quality or service.`,
    imageTitle: "RNK Rent A Car flexible rental packages",
        ...
        >
          {uspItems.map((item, index) => (
            ...
            >
              ...
              <div className="relative bg-black/75 border border-white/10 rounded-3xl px-6 py-6 lg:px-7 lg:py-7 2xl:px-9 2xl:py-9 backdrop-blur-sm shadow-[0_14px_50px_rgba(0,0,0,0.7)] flex flex-col h-full">
                ...
                <motion.button
                  ...
                  className="mt-auto pt-6 inline-flex items-center gap-2 text-[11px] lg:text-[12px] 2xl:text-[13px] uppercase tracking-[0.28em] text-red-900 hover:text-white transition"
                >
                  Read More
        ...
        >
          ...
          >
            ...
            <div className="relative w-full md:w-[45%] h-64 md:h-auto">
              <Image
                src={active.image}
                alt={active.imageTitle}
                title={active.imageTitle}
                fill
