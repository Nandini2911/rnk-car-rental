      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-0 py-12 md:py-16">
        <div className="grid gap-10 md:gap-8 md:grid-cols-4">
          ...
          >
           ...
           <FooterList>
  <FooterLink label="Super Luxury Cars" href="fleet" />
  <FooterLink label="Luxury Cars" href="fleet" />
  <FooterLink label="SUV / MUV" href="fleet" />
  <FooterLink label="Sedan" href="fleet" />
  <FooterLink label="Mini Vans" href="fleet" />
  <FooterLink label="Coaches" href="fleet" />
</FooterList>
          ...
          >
            ...
            <FooterList>
 <FooterLink label="Corporate Car Rental" href="/services/corporate-car-rental" />
  <FooterLink label="Airport & Railway Transfers" href="/services/airport-railway-transfers" />
  <FooterLink label="Luxury Travel" href="/services/luxury-travel" />
  <FooterLink label="Hotel Operations" href="/services/hotel-operations" />
  <FooterLink label="Vacation Rentals" href="/services/vacation-rentals" />
  <FooterLink label="VIP Movements" href="/services/vip-movements" />
  <FooterLink label="Long Term Car Rental" href="/services/long-term-car-rental" />
  <FooterLink label="Event / Wedding Transport" href="/services/event-wedding-transport" />
</FooterList>
...
function FooterHeading({ children }: { children: React.ReactNode }) {
  return (
    <div className="mb-4">
      ...
      <span className="mt-1 block h-0.5 w-10 bg-[#9B0E1A]" />
    </div>
  );
}
