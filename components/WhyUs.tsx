    ...
    <div className="w-full">
      ...
      <AnimatedSection id="why-us-hero">
        ...
        >
          ...
          <div className="pointer-events-none absolute -left-24 -bottom-20 h-64 w-64 rounded-full bg-[#A72740]/20 blur-3xl" />
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-28">
            ...
            >
              ...
              <div className="inline-block">
                ...
                {/* Underline animation */}
                <motion.span
                  className="block h-0.5 w-16 bg-[#A72740] rounded-full mt-2"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
              ...
              <Link href="/contact">
                <motion.button
                  ...
                  className="inline-flex items-center justify-center rounded-full
                             bg-linear-to-r from-[#A72740] via-[#c5385a] to-[#7d1c30]
...
<AnimatedSection id="why-us-features">
  <motion.section
    ...
    className="bg-white text-black py-[clamp(44px,5vw,72px)] px-6"
  >
    <div className="max-w-6xl mx-auto">
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.45, ease: "easeOut" }}
        className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-[clamp(22px,3vw,36px)]"
      >
        <div>
          <p className="text-[10px] tracking-[0.28em] uppercase text-[#A72740] mb-1">
            Core advantages
          </p>
          <h2 className="text-[clamp(18px,2vw,24px)] font-semibold leading-tight">
            What makes RNK{" "}
            <span className="text-[#A72740]">different?</span>
          </h2>
        </div>

        <p className="text-[12.5px] md:text-[13.5px] text-neutral-600 max-w-md leading-relaxed">
          Every journey is treated like a small project — right car, right
          chauffeur, right timing.
        </p>
      </motion.div>
      ...
      >
        {features.map((item, index) => (
          <motion.div
            ...
            whileHover={{
              y: -3,
              boxShadow: "0 12px 28px rgba(74, 6, 6, 0.12)",
            }}
            className="
              p-4
              rounded-xl
          ...
          >
            {/* SUBTLE GLOW */}
            <div className="pointer-events-none absolute -right-8 -top-8 h-16 w-16 rounded-full bg-[#A72740]/70 blur-2xl opacity-60" />

            <p className="text-[#A72740] font-semibold mb-1 text-[10px]">
              0{index + 1}
            </p>

            <h3 className="font-semibold mb-1 text-[13.5px] md:text-[14.5px]">
              {item.title}
            </h3>
      ...
      <AnimatedSection id="why-us-stats">
        ...
        >
          ...
          <div className="pointer-events-none absolute -left-32 -bottom-20 h-64 w-64 rounded-full bg-[#A72740]/20 blur-3xl" />
            ...
            <div className="grid gap-8 md:grid-cols-4">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="relative rounded-2xl border border-white/10 bg-linear-to-b from-white/10 via-black/80 to-black px-5 py-6 flex flex-col items-center md:items-start text-center md:text-left overflow-hidden"
                >
                  {/* subtle accent ring */}
                  ...
                  {/* divider line */}
                  <span className="mt-4 h-px w-10 bg-linear-to-r from-[#A72740]/70 via-white/10 to-transparent" />
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="inline-block">
                ...
                <motion.span
                  className="block h-0.5 w-12 bg-[#A72740] rounded-full mt-2"
                  initial={{ scaleX: 0 }}
      ...
      <AnimatedSection id="why-us-cta">
        ...
        >
          <div className="max-w-5xl mx-auto text-center relative overflow-hidden rounded-3xl border border-[#A72740]/50 bg-linear-to-r from-[#A72740]/60 via-black to-black px-6 py-12 md:px-10">
            {/* subtle glow */}
            ...
            {faqItems.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* BRAND ACCENT */}
                  {isOpen && (
                    <div className="h-0.5 bg-linear-to-r from-[#A72740] to-transparent mx-5" />
                  )}
