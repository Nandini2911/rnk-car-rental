  ...
  return (
    <section id="blog-grid" className="w-full bg-white">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-12 sm:py-16 lg:py-20">
        ...
        <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4">
          {currentBlogs.map((blog) => (
            <Link
              key={blog.slug}
              href={`/blog/${blog.slug}`}
              className="group block border border-gray-200 bg-white overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
              ...
              <div className="p-5 bg-gradient-to-br from-white via-gray-50 to-red-50">
                <div className="flex items-center justify-between gap-3 mb-2">
                  <p className="text-[11px] uppercase tracking-wide text-red-700 font-semibold">
                    {blog.category}
                  </p>
                ...
                <h3 className="font-semibold text-[15px] text-gray-900 mb-2 leading-snug group-hover:text-red-900 transition-colors">
                  {blog.title}
                </h3>
                ...
                <div className="text-[11px] text-gray-500 flex justify-between mt-4">
          ...
          <div className="mt-12 sm:mt-16 flex justify-center">
            <div className="flex flex-wrap items-center justify-center gap-2 px-4 sm:px-6 py-4">
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-lg border bg-white text-gray-700 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Prev
              </button>
