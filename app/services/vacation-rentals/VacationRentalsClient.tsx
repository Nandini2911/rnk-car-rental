...
export default function VacationRentalsPage() {
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      {/* ======================= HERO (Corporate same as Hotel page) ======================= */}
      <section
        className="
      ...
      {/* ================= FULL-WIDTH WHITE SECTION (Corporate like Hotel page) ================= */}
          ...
          <div className="w-full grid gap-10 lg:gap-14 md:grid-cols-2 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-light leading-tight mb-4">
                Make your{" "}
                <span className="font-semibold text-red-900">vacation rental stays</span>{" "}
                completely stress-free.
              </h2>

              <p className="text-[13px] sm:text-sm md:text-[15px] text-black/80 mb-3 leading-relaxed">
                Book a premium chauffeur-driven car to reach your villa, homestay or vacation
                rental — without worrying about directions, taxi hunts or luggage juggle.
              </p>
...
<ul className="space-y-2 text-[12px] sm:text-[13px] text-black/75 leading-relaxed">
  ...
  <li>• All SUVs provided with full 5-door configuration for comfort and access</li>
      ...
      {/* ======================= BG SECTION (Corporate glass style) ======================= */}
      <section
        className="
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 xl:px-16">
          <div className="mx-auto w-full max-w-5xl text-center">
            ...
            >
              ...
              >
                No waiting for cabs. No luggage drama. No confusion finding your rental property in a new town.
              </motion.p>
              ...
              >
                ...
                <span className="text-red-900 font-semibold">from the driveway itself.</span>
              </motion.p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white text-black border-b border-black/10">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24 py-12 sm:py-14 md:py-16 lg:py-20 xl:py-24">
          ...
          >
            <p className="text-red-900 uppercase tracking-[0.30em] text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] mb-2">
              Why RNK?
            </p>

            <h2 className="mx-auto max-w-5xl font-light tracking-tight text-black
                           text-[24px] sm:text-[28px] md:text-[34px] lg:text-[40px] xl:text-[46px] 2xl:text-[50px]
                           leading-[1.15] mb-3 sm:mb-4 text-nowrop">
              Vacations are rare -{" "}
              <span className="font-semibold text-red-900">
      ...
      {/* ======================= VACATION MOBILITY SOLUTIONS (Corporate style) ======================= */}
    ...
    <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24">
      ...
      >
        ...
        >
          <span className="inline-flex flex-wrap justify-center">
            <span className="mr-1">Designed for every</span>
            <span className="font-semibold text-red-900">
              kind of getaway.
            </span>
          </span>
      ...
      <div className="grid w-full justify-items-center gap-4 sm:gap-5 lg:gap-6 xl:gap-7 sm:grid-cols-2 lg:grid-cols-3">
        {[
          ...
          "Flexible hourly & daily rental options",
  "Local chauffeur support with destination insight",
        ].map((item, i) => {
      ...
      {/* ======================= CITIES (same as your original, keep) ======================= */}
      <section>
        <CitiesSection/>
      </section>
      {/* ======================= FAQ (Corporate like Hotel page) ======================= */}
      <section className="bg-black text-white border-b border-white/10">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 xl:px-10 py-14 sm:py-16 md:py-18 lg:py-20">
          ...
          >
            <p className="text-[10px] sm:text-[15px] uppercase tracking-[0.28em] text-red-900mb-3">
              FAQs
            </p>

            <h2 className="text-[20px] sm:text-[22px] md:text-[24px] lg:text-[26px] font-light">
              Vacation Rentals <span className="font-semibold">FAQs</span>
            </h2>
          </motion.div>
      ...
      {/* ======================= SMALL SEO TEXT (Corporate) ======================= */}
      <section className="bg-white text-black border-b border-black/10">
  <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24 py-14 sm:py-16">
    ...
    <motion.p
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5, ease: "easeOut" }}
      className="text-center text-[11px] sm:text-[12px] uppercase tracking-[0.30em] text-red-900 mb-4"
    >
    ...
    <div className="mt-10 grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
      {[
        ...
        <motion.div
          ...
          "
        >
          <p className="text-red-900 font-semibold text-[14px] mb-1">
            {item.title}
          </p>
    ...
    <motion.p
      ...
      className="mt-8 text-center text-[13px] text-black/60"
    >
      ...
      {/* ======================= FINAL CTA (Corporate like Hotel page) ======================= */}
      <section className="bg-black text-white py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            Book a chauffeur-driven car that keeps your entire vacation — from first mile to last — smooth, stylish and stress-free.
          </motion.p>
